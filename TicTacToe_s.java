...
public class TicTacToe_s extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jblPlayerX.setBackground(new java.awt.Color(0, 0, 0));
        jblPlayerX.setFont(new java.awt.Font("Dialog", 1, 48)); // NOI18N
        jblPlayerX.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jblPlayerO.setBackground(new java.awt.Color(0, 0, 0));
        jblPlayerO.setFont(new java.awt.Font("Dialog", 1, 48)); // NOI18N
        jblPlayerO.setForeground(new java.awt.Color(0, 0, 0));
        jblPlayerO.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jPanel13.add(jblPlayerO, java.awt.BorderLayout.PAGE_START);
